...
<head>
    ...
    <title>Data Pesanan | Bowl Express</title>
                    ...
                    <div class="contentSide">
                        <div class="container">
                            ...
                            <ul class="sideNav-link activeBG mt-2">
                                <li>
                                    <a class="nav-link activeColor" href="TotalPesanan.php">
                            ...
                            <ul class="sideNav-link mt-2">
                                <li>
                                    <a class="nav-link" href="TotalMenu.php">
                                        <p><i class="fas fa-chart-pie text-success"></i>Total Menu</p>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="navbarRight">
                        <div class="MoreProfile">
                            <div class="clickValueProfile d-flex">
                                <img src="../Img/Bulgogi_Beef_Rice.jpg" class="rounded-circle clickBtnProfile" alt="">
                        ...
                        <div class="cardTableData mt-4">
                            <div class="container">
                                <div class="headerTable">
                                    <h5 class="mt-2">Data Pemesanan</h5>
                                </div>
                            </div>
